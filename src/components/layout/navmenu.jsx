...
export default function Navmenu() {
  return (
    <Menu as="div" className="relative inline-block text-left opacity-90 lg:hidden">
      <div>
        <MenuButton className=" inline-flex w-full justify-center gap-x-1.5 rounded-md px-3 py-2 text-sm font-semibold text-gray-900 hover:stroke-lightgray bg-transparent dark:stroke-white dark:fill-white">
