const CARD_SIZE = "w-[55vmin] h-[75vmin] lg:w-[55vmin] lg:h-[65vmin] xl:w-[35vmin] xl:h-[50vmin]"
...
const ProjectCard = ({ src, link, description }) => {
    return (
        ...
        <div className={`card group relative flex justify-center ${CARD_SIZE} max-lg:bg-darkgray hover:bg-darkgray`}>
            ...
            <a className="project text-glass absolute bottom-1/2 left-[30%] invisible max-lg:visible md:left-[35.5%] lg:left-[34.5%] xl:left-[35.5%]
