    ...
    <>
      <div className="relative flex md:h-screen xl:h-[80vh] w-full bg-transparent z-10 mt-[150px]">
        <div className="flex flex-col md:flex-row lg:w-[68%] xl:w-[72%] mx-auto bg-transparent">
          ...
          <div className={`relative lg:w-1/2 lg:float-right max-md:mt-10 max-lg:mt-64 transform transition-all duration-1000 ease-out ${isActive ? 'translate-y-0 opacity-100' : 'translate-y-[100px] opacity-0'}`}>
